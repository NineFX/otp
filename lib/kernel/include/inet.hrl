...
-type hostent_addrtype() :: inet | inet6 | caa | cname | gid | hinfo | ns | mb
                          | md | mg | mf | minfo | mx | naptr | null | ptr | soa
                          | spf | srv | txt | uid | uinfo | unspec | uri | wks.
-record(hostent,
	{
	 h_name		  :: inet:hostname(),	%% official name of host
	 h_aliases = []   :: [inet:hostname()],	%% alias list
	 h_addrtype	  :: hostent_addrtype(),	%% host address type
